...
public class Fuente {
	...
	public double getEquivocacionExperimental() {
		double retorno = 0;
		int i, j, k;
		double pADadoB;
		for (i = 0; i < this.cantSimbolosEntrada; i++)
	...
	public double getInformacionMutuaExperimental()
	{
		return this.getEntropiaEntradaExperimental() - this.getEquivocacionExperimental();
	}
