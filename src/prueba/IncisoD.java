...
public class IncisoD {
	...
	public static void main(String[] args)
	{
		...
		int cantSimbolos2 = 5;
		FuenteDeMarkov fuente2 = new FuenteDeMarkov(indice2,transicion2,cantSimbolos2),fuente1 = new FuenteDeMarkov(indice1,transicion1,cantSimbolos1);
		fuente1.generarSecuencia(1000000);
